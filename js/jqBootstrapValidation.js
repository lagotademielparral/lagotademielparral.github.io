        ...
        return this.each(function() {
          ...
          if (settings.options.sniffHtml) {
            ...
            if ($this.attr("pattern") !== undefined) {
              message = "Formato no esperado<!-- data-validation-pattern-message to override -->";
            ...
            if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
              message = "Dirección de correo electrónico no válida<!-- data-validator-validemail-message to override -->";
